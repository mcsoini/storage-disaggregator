...
![png](docs/resources/README_5_1.png)
...
```python
display(df_full_all.set_index(['kind', 'iteration', 'nevent', 'slot']).head(10))
```
...
![png](docs/resources/README_13_0.png)
...
![png](docs/resources/README_15_0.png)
